import os
os.environ['HF_DATASETS_CACHE'] = 'C:/Users/user/llm/datasets/cache/'
...
def main(dataset):
    ngwords = load_ngwords(r"C:\Users\user\llm\datasets\pre-train\HojiChar\hojichar\dict")
    
    batch_size = 32784

    with jsonlines.open('filtered_c4_2.jsonl', mode='w') as writer:
...
if __name__ == '__main__':
    dataset = load_dataset("allenai/c4", "ja", split="train")
    main(dataset)
